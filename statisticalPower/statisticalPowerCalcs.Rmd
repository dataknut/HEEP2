...
# Paramaters ----
rmdParams <- list()
# ref doc - proposed sample sizes ($ constrained)
...
n1 <- p1 * rmdParams$HEEP2full
n2 <- rmdParams$HEEP2full - n1
...
nList <- c(uniqueN(dailyMeanHeatPumpDT$linkID), rmdParams$HEEP2full,rmdParams$HEEP2fullAvail,rmdParams$HEEP2poolOb)
